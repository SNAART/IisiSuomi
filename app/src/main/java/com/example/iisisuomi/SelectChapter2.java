...
public class SelectChapter2 extends AppCompatActivity {
    private App app;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_chapter2);
        app = new App(this);
        ...
        game=0;
        ticked = false;
        Intent GameSelect_Intent = getIntent();
        Bundle GameSelect_Bundle = GameSelect_Intent.getExtras();
        game = GameSelect_Bundle.getInt("Game");
}
    ...
    public void SelectChapter_StartOnClick(View view){
        ...
        if (game==1){
            Intent ChapterSelect2_Intent = new Intent(SelectChapter2.this, FillTheBox.class);
            ChapterSelect2_Intent.putExtras(chapter_data_extra);
            SelectChapter2.this.startActivity(ChapterSelect2_Intent);
        }
        else {
            Intent ChapterSelect2_Intent = new Intent(SelectChapter2.this,WordChoice.class);
            ChapterSelect2_Intent.putExtras(chapter_data_extra);
            SelectChapter2.this.startActivity(ChapterSelect2_Intent);
        }
